...
- [ ] Plugin sürümleri erişilebilir + Kafka 3.7.0 ile uyumlu: Debezium 2.7.3.Final (sqlserver+mongodb), Aiven JDBC 6.10.0, mssql-jdbc 12.8.1.jre11, postgresql 42.7.4, Iceberg kafka-connect-runtime 1.6.1, Apicurio converter 2.6.5.Final.
