#!/usr/bin/env bash
# e2e F4 Trino yolu: pg/mongo/nginx yollarından SONRA (Silver: shop.orders 3 [id1 shipped, id3 new, id4 new] -> kullanıcı 2; crm.customers 3).
set -euo pipefail
...
echo "== servis hesabı + OIDC (analyst1/user1) + rules.json + sandbox"
