...
| Zeppelin | **Shiro + AD (LDAPS)** — OIDC yok (0.12'de pac4j/OIDC realm'i yok) | `activeDirectoryRealm.groupRolesMap` → Shiro rolleri; `[urls]` son kuralı `anyofroles[admin, analyst, student]` ile **rol zorunludur** (`examples/zeppelin/shiro-ad.ini`) |
