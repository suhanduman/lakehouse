...
- Kendi Kubernetes kaynaklarınız: `custom/` — ürün chart'ına dokunmadan GitOps ile kendi CR'larınızı (Spark uygulaması, CronJob…) eklersiniz; ArgoCD `custom` Application'ı bu klasörü izler, örnekler `custom/examples/` (bkz. `custom/README.md`)
